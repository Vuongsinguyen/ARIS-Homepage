...
export default async function BlogPage() {
  ...
  return (
    <>
      <Navbar />
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-purple-600 via-purple-700 to-violet-800 text-white py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-purple-100 max-w-2xl mx-auto">
              Explore our latest insights, tutorials, and industry perspectives
            </p>
          </div>
        </div>
      </section>
